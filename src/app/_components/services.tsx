...
const services = [
   {
      title: "Banho & Tosa",
      description: "Inclui banho com produtos específicos para todo o tipo de pelagem e pele do animal, corte de unhas, limpeza das orelhas e tosa personalizada (higiênica ou estilizada)",
      duration:"1h",
      price:"R$50,00",
      icon:<Scissors/>,
   ...
   {
      title:"Taxi Pet",
      description:"Serviçoes de transporte para levar e buscar os pets no petshop, clínicas veterinárias ou outros locais. Ideal para tutores que não tem tempo ou transporte adequado para locomover os animais.",
      duration:"2h",
      price:"R$80,00",
      icon:<CarTaxiFront/>,
   ...
   },
   {
      ...
      description:"Servições de hospedagem para animais de estimação, ideial para quando os tutores precisam viajarm ou se ausentam por alguns dias. Os pets ficam acomodados em espaços seguros e confortáveis.",
      duration:"1h",
      price:"R$60,00",
      icon:<Hotel/>,
                              ...
                              <div key={index} className="flex-[0_0_100%] min-w-0 md:flex-[0_0_calc(100%/3)] px-3">
                                 <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                                    ...
                                    <div className="border-t border-gray-700 pt-4 flex items-center justify-between">
                                       ...
                                       <a href="#" className="flex items-center justify-center gap-2"><WhatsappLogo className="w-5 h-5"/>Entrar em contato</a>
                                    </div>
                                 </article>
                              </div>
                           ))}
